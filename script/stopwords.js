export const stopWordsArray = [
    ...
    'перешёл в плоскость', 'перешла в плоскость', 'переходит в плоскость', 'переходят в плоскость', 'перешло в плоскость', 'профессиональная компетенция',
    'профессиональные компетенции', 'профессиональной компетенции', 'профессиональную компетенцию', 'профессиональной компетенцией', 
    'профессиональных компетенций', 'наличие большого количества', 'по достоинству оценивается', 'по достоинству оценен', 'по достоинству оценено',
    'по достоинству оценён', 'в рамках этой', 'в рамках этого', 'в рамках этих', 'в качестве'
    ];